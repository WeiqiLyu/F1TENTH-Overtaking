...
def generate_launch_description():
    ...
    rrt_stanley_node = Node(
        ...
        name='ego_rrt_stanley',
        parameters=[config]
    )

    rrt_stanley_node_opp = Node(
        package='rrt_stanley',
        executable='rrt_stanley',
        name='opp_rrt_stanley',
        parameters=[config]
    )

    waypoint_visualiser_node = Node(
    ...
    ld.add_action(rrt_stanley_node_opp)
    ld.add_action(waypoint_visualiser_node)
